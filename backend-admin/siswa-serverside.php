    ...
    while ($row = $dataSiswa->fetch_array()) {
        ...
        $nestedData['aksi'] = '
            <div class="text-center">
                ...
                <a href="hapus-siswa.php?id_siswa='.$row['id_siswa'].'"class="btn btn-danger mb-1 btn-sm" style="font-size: 12px; padding: 3px 8px;" onclick="return confirm(\'Yakin ingin menghapus siswa ini?\');">
