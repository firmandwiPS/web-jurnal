...
if (isset($_POST['ubah'])) {
    if (update_laporan_pkl($_POST, $_FILES) > 0) {
        ...
        document.location.href = 'laporan-pkl-admin.php';
        </script>";
    } else {
        echo "<script>
        ...
        <div class="container-fluid">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" id="file_laporan" name="file_laporan" accept=".pdf,.docx" disabled>
                    <small class="form-text text-muted">File laporan tidak dapat diubah.</small>
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" id="file_project" name="file_project" accept=".zip,.rar" disabled>
                    <small class="form-text text-muted">File project tidak dapat diubah.</small>
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="laporan-pkl-admin.php" class="btn btn-secondary">Kembali</a>
